...
style.innerHTML = '.up-widget {z-index: 10000;height: 100%;width: 100%;position: fixed;left: 0;top: 0;' +
...
var UnitPay = function(params) {
  ...
  this.createWidget = function(params) {
      ...
      var iframeFormUrl = '';
      if (params['domainName'] === 'unitpay.ru') {
          iframeFormUrl = 'https\u003A\/\/widget.unitpay.ru\/pay\/\u0040PUBLIC_ID\u0040';
      } else {
          iframeFormUrl = 'https\u003A\/\/widget.unitpay.money\/pay\/\u0040PUBLIC_ID\u0040';
      }

      // let iframeFormUrl = 'https\u003A\/\/widget.unitpay.ru\/pay\/\u0040PUBLIC_ID\u0040';
      ...
      if (isMobilePhone()) {
          var paymentFormUrl = 'https\u003A\/\/unitpay.ru\/pay\/\u0040PUBLIC_ID\u0040\/\u0040BILLING_CODE\u0040';
